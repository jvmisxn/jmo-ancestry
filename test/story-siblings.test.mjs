...
check(
  ...
  "Alice Adams (b. 1900) was the child of John Adams and Mary Adams.",
);
...
check(
  ...
  "Alice Adams (b. 1900) was the child of John Adams and Mary Adams, one of 2 children alongside Bob Adams.",
);
...
check(
  ...
  "Alice Adams (b. 1900) was the child of John Adams and Mary Adams, one of 3 children alongside Bob Adams and Carol Adams.",
);
...
check(
  ...
  "Alice Adams (b. 1900) was the child of John Adams and Mary Adams, one of 4 children alongside Bob Adams, Carol Adams, and Dan Adams.",
);
